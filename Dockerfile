...
CMD ["java", "-cp", "/usr/local/docker-git-hello-world/target/docker-git-hello-world-1.0.0-SNAPSHOT-jar-with-dependencies.jar", "com.kwolk.docker_git_hello_world.HelloWorldPing"]